...
# Encoder Structure with SimpleRNN
class Encoder(tf.keras.Model):
	...
	def __init__(self, vocab_size, embedding_dim, enc_units, batch_sz):
		...
		self.rnn = SimpleRNN(self.enc_units, return_sequences=True, return_state=True)
...
class Decoder(tf.keras.Model):
	...
	def __init__(self, vocab_size, embedding_dim, dec_units, batch_sz):
		...
		self.embedding = Embedding(vocab_size, embedding_dim)
		self.rnn = SimpleRNN(self.dec_units, return_sequences=True, return_state=True, recurrent_initializer='glorot_uniform')
